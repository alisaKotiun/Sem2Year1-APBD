...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            var result = Emps
                .Where(e => e.Salary == Emps.Max(e2 => e2.Salary))
                .ToList();
            return result;
        }
        ...
        {
            var result = Emps
                .Join(Depts, e => e.Deptno, d => d.Deptno, (e, d) => new
                {
                    e.Ename,
                    e.Job,
                    d.Dname
        ...
        public static IEnumerable<object> Task10()
        {
            var result = Emps
                ...
                .Union(Emps.Select(e => new { Ename = "Brak wartości", Job = (string)null, HireDate = (DateTime?)null }))
                .ToList();
            return result;
        }
        ...
        {
            var result = Emps
                .Join(Depts, e => e.Deptno, d => d.Deptno, (e, d) => new { d.Dname })
                .GroupBy(e => e.Dname)
                .Where(gr => gr.Count() > 1)
                .Select(gr => new
                {
        ...
        {
            var result = Emps.ExtensionTask12();
            return result;
        }
        ...
        {
            int result = arr.ExtensionTask13(); 
            return result;
        }
        ...
        {
            var result = Emps.ExtensionTask14(Depts);
            return result;
        }
    }
    ...
    {
        public static IEnumerable<Emp> ExtensionTask12(this IEnumerable<Emp> emps)
        {
            var result = emps
        ...
        public static int ExtensionTask13(this IEnumerable<int> ints)
        {
            var result = ints
                .GroupBy(i => i)
        ...
        public static IEnumerable<Dept> ExtensionTask14(this IEnumerable<Emp> emps, IEnumerable<Dept> depts)
        {
            var result = depts.
                GroupJoin(emps, d => d.Deptno, e => e.Deptno, (d, e) => new { Dept = d, Count = e.Count() })
